...
<section class="content-header">
  <h1>
    Produtos da Categoria <?php echo htmlspecialchars( $category["category"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
    ...
    <div class="row">
                ...
                <div class="box-body">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <td><?php echo htmlspecialchars( $value1["product"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                            <td>
        ...
        <div class="col-md-6">
            <div class="box box-success">
                <div class="box-header with-border">
                <h3 class="box-title">Produtos na Categoria <?php echo htmlspecialchars( $category["category"], ENT_COMPAT, 'UTF-8', FALSE ); ?></h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <div class="box-body">
